 ...
 * @license Apache 2.0
 */
namespace Matomo\Dependencies\ApiReference\OpenApi\Loggers;
...
class ConsoleLogger extends AbstractLogger implements LoggerInterface
{
    ...
    private const LOG_LEVELS_UP_TO_NOTICE = [LogLevel::DEBUG, LogLevel::INFO, LogLevel::NOTICE];
    /** @var bool */
    ...
    public function log($level, $message, array $context = []) : void
    {
        ...
        if (!in_array($level, self::LOG_LEVELS_UP_TO_NOTICE, \true)) {
            $this->loggedMessageAboveNotice = \true;
        }
