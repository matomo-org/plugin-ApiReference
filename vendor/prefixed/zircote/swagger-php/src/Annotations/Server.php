...
class Server extends AbstractAnnotation
{
     ...
     * @inheritdoc
     */
    public static $_parents = [OpenApi::class, PathItem::class, Operation::class, Get::class, Post::class, Put::class, Delete::class, Patch::class, Head::class, Options::class, Trace::class, Link::class];
    /**
     * @inheritdoc
     */
    public static $_nested = [ServerVariable::class => ['variables', 'serverVariable'], Attachable::class => ['attachables']];
    /**
     * @inheritdoc
     */
