...
use Matomo\Dependencies\ApiReference\OpenApi\Attributes\JsonContent;
use Matomo\Dependencies\ApiReference\OpenApi\Attributes\XmlContent;
...
class RequestBody extends AbstractAnnotation
{
     ...
     * @inheritdoc
     */
    public static $_nested = [MediaType::class => ['content', 'mediaType'], Attachable::class => ['attachables']];
    /**
     * @inheritdoc
     */
