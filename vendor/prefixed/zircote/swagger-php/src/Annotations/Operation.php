...
abstract class Operation extends AbstractAnnotation
{
     ...
     * @inheritdoc
     */
    public static $_nested = [Parameter::class => ['parameters'], PathParameter::class => ['parameters'], Response::class => ['responses', 'response'], ExternalDocumentation::class => 'externalDocs', Server::class => ['servers'], RequestBody::class => 'requestBody', Attachable::class => ['attachables']];
    /**
     * @inheritdoc
     */
