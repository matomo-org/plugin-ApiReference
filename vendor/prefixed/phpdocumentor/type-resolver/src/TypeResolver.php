...
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ArrayShape;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ArrayShapeItem;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\CallableString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ConstExpression;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\False_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\FloatValue;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\HtmlEscapedString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\IntegerRange;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\IntegerValue;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\List_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ListShape;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ListShapeItem;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\LiteralString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\LowercaseString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NegativeInteger;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NonEmptyArray;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NonEmptyList;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NonEmptyLowercaseString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NonEmptyString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\Numeric_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\NumericString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ObjectShape;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\ObjectShapeItem;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\PositiveInteger;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\StringValue;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\TraitString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\PseudoTypes\True_;
...
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Callable_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\CallableParameter;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\ClassString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Collection;
...
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Expression;
...
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\InterfaceString;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Intersection;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Iterable_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Mixed_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Never_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Null_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Nullable;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Object_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Parent_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Resource_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Scalar;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Self_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Static_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\String_;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\This;
use Matomo\Dependencies\OpenApiDocs\phpDocumentor\Reflection\Types\Void_;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprFloatNode;
...
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ArrayShapeItemNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\CallableTypeParameterNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeForParameterNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ObjectShapeItemNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ObjectShapeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\OffsetAccessTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\TypeNode;
use Matomo\Dependencies\OpenApiDocs\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode;
