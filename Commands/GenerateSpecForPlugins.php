 ...
 */
class GenerateSpecForPlugins extends ConsoleCommand
{
    /**
    ...
    {
        $this->setName('openapidocs:generate-single-spec-file');
    ...
    protected function doExecute(): int
    {
        ...
        foreach ($pluginsArray as $pluginName) {
            $annotations[$pluginName] = (StaticContainer::get(AnnotationGenerator::class))->generatePluginApiAnnotations($pluginName, true);
