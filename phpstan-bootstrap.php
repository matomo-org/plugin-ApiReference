...
function oad_alias(string $orig, string $scoped): void {
    if (class_exists($orig) && !class_exists($scoped, false)) class_alias($orig, $scoped);
    if (interface_exists($orig) && !interface_exists($scoped, false)) class_alias($orig, $scoped);
    if (trait_exists($orig) && !trait_exists($scoped, false)) class_alias($orig, $scoped);
}
